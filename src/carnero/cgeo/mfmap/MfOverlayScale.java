...
public class MfOverlayScale extends Overlay {
	    ...
	    public MfOverlayScale(Activity activity, cgBase baseIn, cgSettings settingsIn) {
			base = baseIn;
			settings = settingsIn;
...
//			final double span = ((MfMapView) mapView).getLongitudeSpan() / 1e6;
